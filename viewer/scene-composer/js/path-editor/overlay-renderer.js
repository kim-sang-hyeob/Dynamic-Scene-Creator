...
// Ported from web_viewer_final/overlay-renderer.js to ES module class
...
export class PathOverlayRenderer {
  constructor() {
    ...
    this.lineVAO = null;
    this.pointVAO = null;
    this.indicatorVAO = null;
    this.lineBuffer = null;
    this.pointBuffer = null;
    this.pointColorBuffer = null;
    this.indicatorPosBuffer = null;
    this.indicatorColorBuffer = null;
    this.camLinesVAO = null;
    this.camLinesBuffer = null;
    this.camLinesVertexCount = 0;
    this.lineVertexCount = 0;
    this.pointCount = 0;
    this.animIndicatorPos = null; // [x,y,z] or null
    this.hideOverlay = false; // Set true during recording to hide path/points
    this._uniforms = null;
  }
  ...
  render(viewMatrix, projectionMatrix) {
    ...
    // Compute viewProj
    const vp = multiply4(projectionMatrix, viewMatrix);
